        									...
        									<tr>
        										...
        										<td>
        											<div class="table-data-feature">
        												<button class="item" data-toggle="modal" data-target="#editKasModal<?= $kel->idKas1; ?> " data-placement="top" title="Edit">
        													<i class="zmdi zmdi-edit"></i>
        												</button>
        												<button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
        													<a href="#!" onclick="deleteConfirm('<?= base_url('kasp/delkas2/' . $kel->idKas1); ?>')">
        					...
        					<div class="login-form">
        						<form action="<?= base_url('kasP/addKas'); ?>" method="post">
        							<div class="form-group">
        								<label>Nomor</label>
        								<input class="form-control" type="text" name="id_kas" id="id_kas" value="4000<?= sprintf("%04s", $idKas1); ?>" readonly>
        							</div>
        							<div class="form-group">
