        ...
        <div class="page-content--bgf7">
        									...
        									<tr>
        										...
        										<td>
        											<div class="table-data-feature">
        												<button class="item" data-toggle="modal" data-target="#editKasModal<?= $msk->idKas1; ?>" data-placement="top" title="Edit">
        													<i class="zmdi zmdi-edit"></i>
        												</button>
        												<button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
        													<a href="#!" onclick="deleteConfirm('<?= base_url('kasp/delkas2/' . $msk->idKas1); ?>')">
        					...
        					<div class="login-form">
        						<form action="<?= base_url('kasP/addKas'); ?>" method="post">
        							<div class="form-group">
        								<label>Nomor</label>
        								<input class="form-control" type="text" name="id_kas1" id="id_kas1" value="4000<?= sprintf("%04s", $idKas1); ?>" readonly>
        							</div>
        							<div class="form-group">
			...
			foreach ($masuk as $val): $no++; ?>
        		<div class="modal fade" id="editKasModal<?= $val->idKas1; ?>" tabindex="-1" role="dialog" aria-labelledby="editKasModal" aria-hidden="true">
        			<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        				<div class="modal-content">
        					...
        					<div class="modal-body">
        						<div class="login-form">
        							<?= form_open_multipart('kasp/editkas2'); ?>
        							<input type="hidden" name="idKas1" id="idKas1" value="<?= $val->idKas1; ?>">
        							<div class="form-group">
        								<label>Keterangan</label>
